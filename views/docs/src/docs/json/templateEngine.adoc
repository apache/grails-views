...
The JSON Views plugin registers a bean called `jsonTemplateEngine` of type link:groovydoc/grails/plugin/json/view/JsonViewTemplateEngine.html[JsonViewTemplateEngine].
