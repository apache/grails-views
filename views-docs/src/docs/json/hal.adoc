...
The JSON views plugin for Grails provides HAL support out-of-the-box. All JSON views have access to the `hal` instance which implements link:groovydoc/grails/plugin/json/view/api/HalViewHelper.html[HalViewHelper].
